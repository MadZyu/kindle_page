	...
	xhr.onreadystatechange = function() {
		if (this.readyState == 4) {
			...
			if (data.code == 200) {
				...
				document.getElementById("lunar").innerHTML = lunar_data.ganzhi_year + "年" + lunar_data.lunar_month_chinese + lunar_data.lunar_day_chinese
			} else {
...
function addEvent(autoMode) {
	document.getElementById("apmOuterWrapper").addEventListener("click",
	function() {
